...
from api.views import StaffQuizListView, QuizReviewListView
...
urlpatterns = patterns('',
   ...
   url(r'^users/(?P<u_id>[0-9]+)/quizes/(?P<q_id>[0-9]+)/review/$', QuizReviewListView.as_view(), name='api_user_quiz_review'),
